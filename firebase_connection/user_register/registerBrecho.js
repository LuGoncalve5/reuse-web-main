...
function writeUserDataBrecho(uid, nome, email, telefone, usuario, cnpj, tipoPessoa, tipoUsuario) {
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        await writeUserDataBrecho(user.uid, nomeCompleto, email, telefone, nomeUsuario, cnpj, tipoPessoa, tipoUsuario);
